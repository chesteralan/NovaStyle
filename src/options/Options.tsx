          ...
          <Accordion title="Editor Settings" headerClass="w-full flex items-center justify-between px-4 py-3 text-left hover:bg-slate-50" titleClass="font-medium text-sm text-slate-800" contentClass="border-t border-slate-100 px-4 py-3">
            <div className="space-y-3">
              {([
                ...
                { key: 'animationEditor' as const, label: 'Animation & Transitions' },
                { key: 'listEditor' as const, label: 'List Styles' },
                { key: 'tableEditor' as const, label: 'Table Layout' },
                { key: 'columnsEditor' as const, label: 'CSS Columns' },
                { key: 'scrollSnapEditor' as const, label: 'Scroll Snap' },
                { key: 'svgEditor' as const, label: 'SVG Properties' },
                { key: 'writingModeEditor' as const, label: 'Writing Mode' },
