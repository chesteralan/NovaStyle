...
const defaultSettings: NovaStyleSettings = {
  ...
  visibleEditors: {
    ...
    tableEditor: true,
    columnsEditor: true,
    scrollSnapEditor: true,
    svgEditor: true,
    writingModeEditor: true,
    fontDetector: true,
    classResolver: true,
  ...
  try {
    ...
    return {
      ...
      visibleEditors: {
        ...
        listEditor: saved.visibleEditors?.listEditor ?? defaultSettings.visibleEditors.listEditor,
        tableEditor: saved.visibleEditors?.tableEditor ?? defaultSettings.visibleEditors.tableEditor,
        columnsEditor: saved.visibleEditors?.columnsEditor ?? defaultSettings.visibleEditors.columnsEditor,
        scrollSnapEditor: saved.visibleEditors?.scrollSnapEditor ?? defaultSettings.visibleEditors.scrollSnapEditor,
        svgEditor: saved.visibleEditors?.svgEditor ?? defaultSettings.visibleEditors.svgEditor,
        writingModeEditor: saved.visibleEditors?.writingModeEditor ?? defaultSettings.visibleEditors.writingModeEditor,
