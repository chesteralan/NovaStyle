...
const GRID = [
  ...
  'grid-cols-5', 'grid-cols-6', 'grid-cols-7', 'grid-cols-12',
...
const SPACING = [
  'p-0', 'p-0.5', 'p-1', 'p-1.5', 'p-2', 'p-2.5', 'p-3',
  'p-4', 'p-5', 'p-6', 'p-8', 'p-10', 'p-12', 'p-16',
  ...
  'm-0', 'm-0.5', 'm-1', 'm-2', 'm-3', 'm-4', 'm-6', 'm-8', 'm-auto',
  'mx-0', 'mx-1', 'mx-2', 'mx-4', 'mx-auto',
  'my-0', 'my-1', 'my-2', 'my-4', 'my-auto',
...
const SIZING = [
  ...
  'w-10', 'w-12', 'w-16', 'w-20', 'w-24', 'w-32', 'w-40',
  'w-48', 'w-56', 'w-64', 'w-72', 'w-80', 'w-96',
  'w-auto', 'w-1/2', 'w-1/3', 'w-2/3', 'w-1/4', 'w-3/4',
  'w-full', 'w-screen', 'w-min', 'w-max', 'w-fit',
  'h-0', 'h-1', 'h-2', 'h-3', 'h-4', 'h-5', 'h-6', 'h-8',
  'h-10', 'h-12', 'h-16', 'h-20', 'h-24', 'h-32', 'h-40',
  'h-48', 'h-56', 'h-64',
  'h-auto', 'h-1/2', 'h-1/3', 'h-2/3', 'h-1/4', 'h-3/4',
  'h-full', 'h-screen', 'h-min', 'h-max', 'h-fit',
  'max-w-xs', 'max-w-sm', 'max-w-md', 'max-w-lg', 'max-w-xl',
  'max-w-2xl', 'max-w-3xl', 'max-w-4xl', 'max-w-5xl', 'max-w-6xl',
  'max-w-7xl', 'max-w-full', 'max-w-none',
...
const TYPOGRAPHY = [
  ...
  'truncate', 'text-wrap', 'text-nowrap', 'text-balance',
...
const BACKGROUNDS = [
  ...
  'bg-green-50', 'bg-green-100', 'bg-green-200', 'bg-green-500', 'bg-green-600',
  'bg-yellow-50', 'bg-yellow-100', 'bg-yellow-200', 'bg-yellow-500',
  'bg-purple-50', 'bg-purple-100', 'bg-purple-200', 'bg-purple-500', 'bg-purple-600',
  'bg-orange-50', 'bg-orange-100', 'bg-orange-500',
  'bg-pink-50', 'bg-pink-100', 'bg-pink-500',
  'bg-cover', 'bg-contain', 'bg-repeat', 'bg-no-repeat',
...
const BORDERS = [
  ...
  'border-transparent', 'border-current', 'border-black',
